...
# Path of this script: D:\Bruh_ELE_ELECTRONIC_ENGINEERING-B_LAB\Lab06-Project\vitis_ws\jumping_box_system\_ide\scripts\debugger_jumping_box-default_1.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source D:\Bruh_ELE_ELECTRONIC_ENGINEERING-B_LAB\Lab06-Project\vitis_ws\jumping_box_system\_ide\scripts\debugger_jumping_box-default_1.tcl
# 
...
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
dow D:/Bruh_ELE_ELECTRONIC_ENGINEERING-B_LAB/Lab06-Project/vitis_ws/jumping_box/Release/jumping_box.elf
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
con
