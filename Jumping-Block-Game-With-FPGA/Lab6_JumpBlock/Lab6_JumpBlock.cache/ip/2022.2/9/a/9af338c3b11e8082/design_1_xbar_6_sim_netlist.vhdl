...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_addr_arbiter_sasd is
  ...
  signal \^m_axi_arready[3]\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.last_rr_hot[1]_i_2\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_enc_i[1]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_enc_i[1]_i_3\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_enc_i[1]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_enc_i[1]_i_5\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[3]_i_14\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[3]_i_3\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[3]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \gen_arbiter.m_valid_i_i_4\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \m_atarget_enc[2]_i_4\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[8]_i_10\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \m_atarget_hot[8]_i_12\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \m_atarget_hot[8]_i_13\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_4\ : label is "soft_lutpair2";
...
begin
  ...
  \m_axi_arready[3]\(0) <= \^m_axi_arready[3]\(0);
...
\gen_arbiter.m_grant_hot_i[3]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => aa_grant_rnw,
      I2 => m_ready_d_0(0),
      I3 => \gen_arbiter.m_grant_hot_i_reg[0]_0\(0),
      I4 => sr_rvalid,
...
m_valid_i_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4F004400"
        ...
        port map (
      I0 => \gen_arbiter.m_valid_i_i_2_1\,
      I1 => m_axi_rvalid(1),
...
\s_axi_bvalid[1]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => aa_grant_rnw,
      I2 => m_ready_d(0),
      I3 => \^gen_arbiter.m_grant_hot_i_reg[3]_0\(1),
      I4 => s_axi_bvalid_0_sn_1,
      O => s_axi_bvalid(1)
    );
...
\gen_arbiter.m_grant_hot_i[3]_i_10\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFF400000000"
        ...
        port map (
      I0 => \gen_arbiter.m_grant_hot_i[3]_i_6\,
      I1 => m_axi_arready(1),
      I2 => \gen_arbiter.m_grant_hot_i[3]_i_6_0\,
      I3 => \gen_arbiter.m_grant_hot_i[3]_i_6_1\,
      I4 => \gen_arbiter.m_grant_hot_i[3]_i_16_n_0\,
...
\gen_arbiter.m_grant_hot_i[3]_i_8\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \gen_arbiter.m_grant_hot_i[3]_i_6\,
      I1 => m_axi_awready(0),
      I2 => \gen_arbiter.m_grant_hot_i[3]_i_11_n_0\,
      I3 => \gen_arbiter.m_grant_hot_i[3]_i_2\,
      I4 => \gen_arbiter.m_grant_hot_i[3]_i_2_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_splitter is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \s_axi_bvalid[1]_INST_0_i_6\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \s_axi_wready[1]_INST_0_i_6\ : label is "soft_lutpair48";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_register_slice_v2_1_27_axic_register_slice is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \gen_arbiter.m_valid_i_i_7\ : label is "soft_lutpair42";
  ...
  attribute SOFT_HLUTNM of \m_payload_i[33]_i_4\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of m_valid_i_i_8 : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of m_valid_i_i_9 : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_1\ : label is "soft_lutpair40";
...
\gen_arbiter.m_valid_i_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
addr_arbiter_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_addr_arbiter_sasd
     port map (
      ...
      E(0) => p_1_in,
      Q(1) => reg_slice_r_n_54,
      Q(0) => reg_slice_r_n_55,
      SR(0) => reset,
      aa_rready => aa_rready,
      aclk => aclk,
      any_error => any_error,
      ...
      \m_atarget_enc_reg[3]\ => addr_arbiter_inst_n_82,
      ...
      \m_axi_arready[3]\(0) => m_ready_d0(1),
      \m_axi_arready[7]\ => addr_arbiter_inst_n_139,
      m_axi_arready_0_sp_1 => addr_arbiter_inst_n_138,
...
\gen_decerr.decerr_slave_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_decerr_slave
     port map (
      ...
      aclk => aclk,
      aresetn_d => aresetn_d,
      \gen_arbiter.m_grant_hot_i[3]_i_2\ => splitter_aw_n_7,
      \gen_arbiter.m_grant_hot_i[3]_i_2_0\ => splitter_aw_n_2,
      \gen_arbiter.m_grant_hot_i[3]_i_2_1\ => addr_arbiter_inst_n_78,
      \gen_arbiter.m_grant_hot_i[3]_i_6\ => addr_arbiter_inst_n_83,
      \gen_arbiter.m_grant_hot_i[3]_i_6_0\ => addr_arbiter_inst_n_138,
      \gen_arbiter.m_grant_hot_i[3]_i_6_1\ => addr_arbiter_inst_n_139,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_axi_crossbar is
  ...
  attribute C_M_AXI_BASE_ADDR of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_axi_crossbar : entity is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
  attribute C_M_AXI_READ_CONNECTIVITY of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_axi_crossbar : entity is "256'";
  ...
  attribute P_S_AXI_SUPPORTS_WRITE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_axi_crossbar : entity is "4'b0011";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
