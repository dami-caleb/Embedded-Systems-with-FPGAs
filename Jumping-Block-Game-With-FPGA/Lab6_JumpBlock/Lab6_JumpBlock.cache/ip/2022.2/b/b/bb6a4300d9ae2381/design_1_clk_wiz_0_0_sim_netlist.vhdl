...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_design_1_clk_wiz_0_0_clk_wiz is
  ...
  signal clk_out2_design_1_clk_wiz_0_0_en_clk : STD_LOGIC;
...
clkout2_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg2(7),
      CE1 => '0',
      I0 => clk_out2_design_1_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out2,
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out2_design_1_clk_wiz_0_0_en_clk
    );
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_design_1_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset_high,
      D => \^locked\,
      Q => seq_reg2(0)
